        ...
        <div className="column " style={{ width: '33%' }}>
          <div className="card">
            ...
            <div className="container">
              <h2>Praharsh Gaudani</h2>
              <p className="title">Team 6 Juhu | Communication Lead</p>
              <p style={{  textAlign: 'justify' }}>
                With almost 2 years of professional experience in IT, I've cultivated expertise in various areas. Beginning with Java, I led GUI projects, then transitioned to agile methodologies, contributing significantly to a Mental Health Web App for University Project. At Taskial Solutions, I excelled as a full-stack web developer, mastering front-end and back-end technologies. Additionally, I pursued personal growth through a 12-week Harvard program, emphasizing my dedication to continuous learning.
              </p>
              <p>
                <button className="button"><a href="mailto:gaudanipraharsh@gmail.com" className='d'>Contact Me</a></button>
              </p>
        ...
        <div className="column" style={{ width: '34%' }}>
          <div className="card">
            ...
            <div className="container">
              ...
              <p>
                <button className="button"><a href="mailto:snehalkudaleemail@gmail.com" className='d'>Contact Me</a></button>
              </p>
              <div className="social-icons">
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
                  <i className="fab fa-facebook-f"></i>
